        ...
        <table class="table table-hover">
            ...
            @foreach($product_info->skus as $sku)
                <tr data-sku_id="{{$sku->id}}">
                    <td>{{$sku->code}}</td>
                    <td class="actual_inventory_td" data-ori_stock="1500">
                        <span>1500</span>
                    </td>
                    <td>
                        <input type="text" name="product_inventories[{{$sku->id}}][highest]" class="form-control" value="" oninput="this.value=value.replace(/[^\d]/g, '')">
                    </td>
                    <td>
                        <input type="text" name="product_inventories[{{$sku->id}}][lowest]" class="form-control" value="" oninput="this.value=value.replace(/[^\d]/g, '')">
                    </td>
                </tr>
            @endforeach
            </tbody>
